...
<div class="container custom-height-container">
    <div class="container rounded w-50 my-5 custom-margin-top d-flex flex-column justify-content-center custom-background-color">
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <div class="w-100 mt-4 d-flex justify-content-center mt-5" style="padding-bottom: -50px;">
            ...
            <div class="mb-3 w-75" style="margin-left: auto; margin-right: auto">
                ...
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Mail" name="password"  value="{{ Auth::user()->email }}" disabled>
            </div>
            <!--
            <div class="mb-3 w-75" style="margin-left: auto; margin-right: auto">
                <label for="exampleFormControlInput1" class="form-label">Confirmation du mot de passe</label>
                <input type="password" class="form-control" id="exampleFormControlInput1" placeholder="Confirmation du mot de passe" name="confPassword" value="{{ Auth::user()->password }}" disabled>
            </div>
            -->
