...
<div class="container my-5 d-flex flex-column align-items-center">
    <div class="btn-group mb-4" role="group" aria-label="Basic outlined example">
        ...
        <a href="/pompier/demande">
            <button class="btn btn-secondary btn-danger" type="button">
                Ajouter
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group gap-1" role="group" aria-label="Basic mixed styles example">
                        <a href="#"><button type="button" class="btn btn-success">Afficher</button></a>
                        <a href="/pompier/update/"><button type="button" class="btn btn-warning">Modifier</button></a>
