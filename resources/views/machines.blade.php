...
<head>
    ...
    <link rel="stylesheet" href="{{asset('font/ApercuMonoPro-Regular.woff2')}}">
    ...
    <style>
        ...
        @font-face {
            font-family: "Apercu";
            src: url(../font/Sailec-Bold.woff2) format("woff2");
        }
        *{
...
<div class="container mb-5 d-flex flex-column align-items-center" style="margin-top: 115px;">
    ...
    <a href="{{ route('home') }}">
        <button class="btn btn-secondary btn-dark mt-5 mb-5" type="button">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" fill="currentColor" class="bi bi-backspace-fill" viewBox="0 0 16 20">
